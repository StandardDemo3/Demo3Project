package com.siteproject.codefiles;

public class LogicalOperator<LogicalOperator> {
	     ...
	     * @return 
	     */    
	    public void ForgetPasswordOption(int initialCap) {
	    ...
	    public boolean equals(Object other){
	        ...
	        if(other == null)
	            ...
	            while(i < iSize && result){
	                result = this.iValues[i].equals(iValues[i] );
	                i++;
	            }
	        }
	        return result;     
